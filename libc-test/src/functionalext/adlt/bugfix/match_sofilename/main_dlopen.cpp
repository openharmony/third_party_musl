...
#ifdef SO_TYPE_TAG
static const char *add_lib = "libadlt_bugfix_match_sofilename_" STRIFY(SO_TYPE_TAG) "_add.so";
static const char *sub_lib = "libadlt_bugfix_match_sofilename_" STRIFY(SO_TYPE_TAG) "_sub.so";
#else
