...
​      strtoull_l - convert a string to an unsigned long long integer.
...
​      This function is a POSIX extension (locale-specific version of strtoull) and is not part of the C99 standard, It is available in POSIX.1-2001 and POSIX.1-2008.
