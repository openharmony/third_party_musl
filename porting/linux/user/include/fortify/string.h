...
size_t __strlcpy_diagnose(char*, const char*, size_t, size_t);
...
__DIAGNOSE_OVERLOAD
{
    ...
    return __memchr_diagnose(s, c, n, bos);
}
...
__DIAGNOSE_OVERLOAD
{
    ...
    if (bos != __DIAGNOSE_FORTIFY_UNKNOWN_SIZE) {
        return __strchr_diagnose(s, c, bos);
    }
#endif
...
__DIAGNOSE_OVERLOAD
{
    ...
    if (bos != __DIAGNOSE_FORTIFY_UNKNOWN_SIZE) {
        return __strrchr_diagnose(s, c, bos);
    }
#endif
